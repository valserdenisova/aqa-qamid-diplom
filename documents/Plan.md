...
* Изучение технического задания, подготовка  окружения проекта, подключение библиотек, зависимостей, запуск и изучение приложения – 10 часов.

* Разработка и написание плана автоматизации тестирования - 5 часов.

* Написания кода и отладка автотестов - 10 часов.
...
* Проведены автотесты `28.04.2025`
* Отчётные документов по итогам тестирования `30.04.2025`
* Отчётные документов по итогам автоматизации `02.05.2025`
